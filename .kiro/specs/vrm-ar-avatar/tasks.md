...
- [ ] 6. アバター制御とアニメーションシステムの実装
  - [x] 6.1 AvatarControllerの基本操作機能を実装
    - アバターの位置、回転、スケール変更機能を実装
    - タッチジェスチャーによる操作機能を作成
    - リアルタイムプレビュー更新機能を実装
    - _Requirements: 2.1, 2.2, 2.3, 2.4_

  - [x] 6.2 表情とポーズ制御システムを実装
    - VRM表情データの適用機能を実装
