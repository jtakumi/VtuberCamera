...
import com.example.vtubercamera.databinding.FragmentSecondBinding
...
class secondFragment : Fragment(), BackButtonCallBack {
    ...
    private fun showCurrentTimeClock(view:View) {
        val currentTime=TextClock(context).format24Hour
