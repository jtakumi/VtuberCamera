...
#### 📅 2025-09-04: ピンチジェスチャーによるレンズ切り替え機能

**🎯 主な変更内容**
- **マルチカメラ対応**: Camera2 APIとCameraXを使ったカメラ能力検出システム
- **ピンチジェスチャー制御**: ピンチアウトで広角レンズ、ピンチインで通常レンズに切り替え
- **レンズ切り替えUI**: 現在のレンズ表示とスムーズな切り替えフィードバック
- **デバイス互換性**: 複数カメラ非対応端末での適切なフォールバック機能
- **エラーハンドリング**: 権限チェックと例外処理による安定動作
